...
void wallFollow(){
  ...
  if( readFrontUS() < 10 ){
  ...
  else if(diff ==  0 && diff==diff2){ //APOSTASH 0 EUTHEIA KINHSH 
      moveForward();
  
   }//if

   else if( diff2 < 0 && diff2<diff && diff<0){ //APOSTASH APO TON MPROSTA DEKSIA LIGO ARISTERA
      goLeft();
     }//else if
     
   else if (diff > 0 &&  diff2>diff && diff2>0){ //APOSTASH APO TON PISW DEKSIA  LIGO ARISTERA  
     goRight();  
     }//else if
   ...
   //GIA STROFH  
   if ( readRightUS()<25 && readRight2US()<25 && readFrontUS()<10 )//&& readLeftUS()>25) //OLOI PANW APO 25 TOTE STROFH ARISTERH 
   {
     turnLeft();
     delay(200);
    ...
    else if ( readRightUS()>25 && readRight2US()>25 && readFrontUS()<10 )//&& readLeftUS()<25) //OLOI PANW APO 25 TOTE STROFH DEKSIA
   {
     turnRight();
     delay(200);
   ...
   else if (  readRight2US()<25 && readRightUS()<25 && readFrontUS()>10 )//&& readLeftUS()>40 ) //ARISTERA TOIXOS , DEKSIA EXEI XWRO ,MPROSTA XWROS LIGO DEKSIAAA
   {
     goLeft();
     delay(100);
     moveForward();
   ...
   else if (readFrontUS()>3000) //LOGIKO LATHOS KANEI LIGO PISW 
   {
     moveBackward();
     delay(500);
   }//else if
