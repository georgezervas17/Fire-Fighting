...
void wallFollow(){
  ...
  /*else if(diff ==  0 && diff==diff2) //APOSTASH 0 EUTHEIA KINHSH 
   ...
   else if( diff2 < 0) //APOSTASH APO TON MPROSTA DEKSIA LIGO ARISTERA
    {
      goLeft();
      
     }//else if
     
   else if (diff2 > 0) //APOSTASH APO TON PISW DEKSIA  LIGO ARISTERA  
     {
     goRight();
     
     }//else if
     
   /*else if(diff >10 && diff2> 10) // DIORTHWSH KINHSHS GIA POLU MAKRIA 
   {
     goRight();
     delay(50);
   }//else  if
   
   else if( diff < 0 && diff2 < 0 ) // DIORTHWSH KINHSHS GIA POLU MAKRIA 
   {
     goLeft();
   } //else if 
   ...
   */
   ...
   if ( readRightUS()<15 && readRight2US()>25 ) //MPROSTA DEKSIA  KENO, PISW DEKSIA TOIXOS
   {
     moveForward();
     delay(350);
     turnRight();
